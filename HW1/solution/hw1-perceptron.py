...
# Deep Learning Homework 1 - Perceptron
...
class Perceptron:
    ...
    def predict(self, X):
        ...
        """
        outputs = self.W @ X.T
        y_hat = np.argmax(outputs, axis=0)
        return y_hat
...
def main(args):
    ...
    results_dir = os.path.join("Results", "Perceptron_results")
    ...
    best_model = Perceptron.load(save_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--save-path", default="perceptron.pkl")
